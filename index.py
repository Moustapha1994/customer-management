...
def OnSelected(event):
    ...
    UpdateWindow.title("Customer management")
    width = 400
    height = 300
    screen_width = root.winfo_screenwidth()
    screen_height = root.winfo_screenheight()
...
def AddNewWindow():
    ...
    CONTACT.set("")
    NewWindow = Toplevel()
    NewWindow.title("Customer management")
    width = 400
    height = 300
    screen_width = root.winfo_screenwidth()
    screen_height = root.winfo_screenheight()
    ...
    #===================LABELS==============================
    lbl_title = Label(FormTitle, text="Adding New Customers", font=('arial', 16), bg="#66ff66",  width = 300)
    lbl_title.pack(fill=X)
    lbl_firstname = Label(ContactForm, text="Firstname", font=('arial', 14), bd=5)
    lbl_firstname.grid(row=0, sticky=W)
    lbl_lastname = Label(ContactForm, text="Lastname", font=('arial', 14), bd=5)
...
#============================LABELS======================================
lbl_title = Label(Top, text="Acustomer management Using Python", font=('arial', 16), width=500)
lbl_title.pack(fill=X)
